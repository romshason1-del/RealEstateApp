...
import { NYC_PROPERTY_UI_PRODUCTION_V10_COL } from "@/lib/us/us-nyc-property-ui-production-schema";

/** BigQuery project that owns `real_estate_us` and NYC production UI tables. */
export const US_NYC_APP_OUTPUT_DATA_PROJECT = "streetiq-bigquery";

const DEFAULT_DATASET_AND_TABLE = "real_estate_us.us_nyc_property_ui_production_v10";

/**
 * Fully qualified default: `streetiq-bigquery.real_estate_us.us_nyc_property_ui_production_v10`.
...
/** Row lookup uses {@link NYC_PROPERTY_UI_PRODUCTION_V10_COL.lookup_address}. */
export const US_NYC_APP_OUTPUT_ADDRESS_COL = NYC_PROPERTY_UI_PRODUCTION_V10_COL.lookup_address;
