...
/** BigQuery project that owns `real_estate_us` and `us_nyc_app_output_final_v5` in production. */
export const US_NYC_APP_OUTPUT_DATA_PROJECT = "streetiq-bigquery";

const DEFAULT_DATASET_AND_TABLE = "real_estate_us.us_nyc_app_output_final_v5";

/**
 * Fully qualified default: `streetiq-bigquery.real_estate_us.us_nyc_app_output_final_v5`.
...
/** Row lookup uses {@link NYC_APP_OUTPUT_V5_COL.lookup_address}. */
export const US_NYC_APP_OUTPUT_ADDRESS_COL = NYC_APP_OUTPUT_V5_COL.lookup_address;
